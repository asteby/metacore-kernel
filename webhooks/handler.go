...
func (h *Handler) list(c *fiber.Ctx) error {
	...
	items, err := h.service.List(c.Context(), ot, oid)
	if err != nil {
...
func (h *Handler) create(c *fiber.Ctx) error {
	...
	w.OwnerType = ot
	w.OwnerID = oid
	if err := h.service.Create(c.Context(), &w); err != nil {
		return fail(c, fiber.StatusBadRequest, err.Error())
	}
	return ok(c, w)
}
...
func (h *Handler) get(c *fiber.Ctx) error {
	...
	w, err := h.service.Get(c.Context(), id)
...
func (h *Handler) test(c *fiber.Ctx) error {
	...
	d, err := h.service.Test(c.Context(), id)
	if err == ErrWebhookNotFound {
		return fail(c, fiber.StatusNotFound, err.Error())
	}
	if err != nil {
...
func (h *Handler) logs(c *fiber.Ctx) error {
	...
	items, total, err := h.service.Logs(c.Context(), id, params)
	if err != nil {
		return fail(c, fiber.StatusInternalServerError, err.Error())
	}
...
func (h *Handler) replay(c *fiber.Ctx) error {
	...
	d, err := h.service.Replay(c.Context(), id)
